...
impl ToPyObject for NeuralNetwork {
    fn to_object(&self, py: Python<'_>) -> PyObject {
        ...
        let _ = dict.set_item("genome", &self.genome);
        //TODO: Enable NeuralNetwork for #[pyclass]
        //dict.set_item("graph", self.graph);
        let _ = dict.set_item("network_output", &self.network_output);
        let _ = dict.set_item("node_identity_map", python_friendly_map.into_py_dict(py));
